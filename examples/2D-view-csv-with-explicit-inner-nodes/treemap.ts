...
import {Configuration, initialize, Renderer, Visualization} from '../../source/treemap-renderer';

import {CSVData} from './csvdata';

import {Example} from '../example';
import {VisualizationType} from "../../source/visualization";
...
export class ExplicitInnerNodesTreemapExample extends Example {
    ...
    initialize(element: HTMLCanvasElement | string): boolean {
        ...
        this._visualization = new Visualization(VisualizationType.VISUALIZATION_2D);
